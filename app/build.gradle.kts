...
android {
    ...
    signingConfigs {
        // Read from a local `keystore.properties`, which is deliberately not in the repository.
        // Without it the release build stays unsigned, the way it is upstream and in CI.
